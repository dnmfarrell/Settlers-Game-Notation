...
module.exports = function generate_properties(it) {
  ...
  var $lvl = it.level,
    ...
    $errSchemaPath = it.errSchemaPath + '/' + 'properties',
        ...
        if ($removeAdditional) {
          ...
          if (!it.compositeRule && $breakOnError) {
            ...
            if (it.createErrors !== false) {
              out += ' { keyword: \'' + ('additionalProperties') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: "' + ($errSchemaPath) + '" , params: { additionalProperty: \'' + ($additionalProperty) + '\' } ';
        ...
        if (it.util.schemaHasRules($sch, it.RULES.all)) {
          ...
          if ($requiredProperties[$propertyKey]) {
            ...
            if (!it.compositeRule && $breakOnError) {
              out += ' validate.errors = [ '; /* istanbul ignore else */
              if (it.createErrors !== false) {
                out += ' { keyword: \'' + ('required') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: "' + ($errSchemaPath) + '" , params: { missingProperty: \'' + ($missingProperty) + '\' } ';
                if (it.opts.messages !== false) {
                  out += ' , message: \'';
                  if (it.opts._errorDataPathProperty) {
          ...
          if ($pgMin !== undefined || $pgMax !== undefined) {
            ...
            if ($pgMin !== undefined) {
              ...
              if (!it.compositeRule && $breakOnError) {
                out += ' validate.errors = [ '; /* istanbul ignore else */
                if (it.createErrors !== false) {
                  out += ' { keyword: \'' + ('patternGroups') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: "' + ($errSchemaPath) + '" , params: { reason: \'' + ($reason) + '\', limit: ' + ($limit) + ', pattern: \'' + (it.util.escapeQuotes($pgProperty)) + '\' } ';
                  if (it.opts.messages !== false) {
