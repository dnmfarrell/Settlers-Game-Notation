...
Every tile is listed with its coordinates, type and resource number. C<null> represents no resource number. Harbors are declared at path locations. The 4th edition starter map layout:
